output "vpc_id_project_codegroup_apps" {
  ...
  value       = aws_vpc.vpc_modulo_project_codegroup_apps.id
}

output "vpc_cidr_project_codegroup_apps" {
  description = "CIDR da vpc que será usado no projeto codegroup apps"
  value       = aws_vpc.vpc_modulo_project_codegroup_apps.cidr_block
}
...
output "id_subnet_public_1_project_codegroup_apps" {
  ...
  value       = aws_subnet.public_subnet_1_modulo_project_codegroup_apps.id
}
...
output "id_subnet_public_2_project_codegroup_apps" {
  ...
  value       = aws_subnet.public_subnet_2_modulo_project_codegroup_apps.id
}
...
output "id_subnet_private_1_project_codegroup_apps" {
  ...
  value       = aws_subnet.private_subnet_1_modulo_project_codegroup_apps.id
}
...
output "id_subnet_private_2_project_codegroup_apps" {
  ...
  value       = aws_subnet.private_subnet_2_modulo_project_codegroup_apps.id
}
...
output "cidr_blocks_public_subnet_1_project_codegroup_apps" {
  ...
  value       = aws_subnet.public_subnet_1_modulo_project_codegroup_apps.cidr_block
}
...
output "cidr_blocks_public_subnet_2_project_codegroup_apps" {
  ...
  value       = aws_subnet.public_subnet_2_modulo_project_codegroup_apps.cidr_block
}
...
output "cidr_blocks_private_subnet_1_project_codegroup_apps" {
  ...
  value       = aws_subnet.private_subnet_1_modulo_project_codegroup_apps.cidr_block
}
...
output "cidr_blocks_private_subnet_2_project_codegroup_apps" {
  ...
  value       = aws_subnet.private_subnet_2_modulo_project_codegroup_apps.cidr_block
}

output "id_igw_project_codegroup_apps" {
  description = "id da igw que será usado no projeto codegroup apps"
  value       = aws_internet_gateway.igw_module_codegroup_apps.id
}
...
output "id_route_table_public_project_codegroup_apps" {
  ...
  value       = aws_route_table.rt_project_modulo_codegroup_apps.id
}
